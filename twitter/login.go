...
func LoginHandler(config *oauth1.Config, failure goji.Handler) goji.Handler {
...
func twitterHandler(config *oauth1.Config, success, failure goji.Handler) goji.Handler {
	if failure == nil {
